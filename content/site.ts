...
export const reasonsToEntrust = [
  ...
  },
  {
    ...
    text: "特定製品や開発受注を前提とせず、採用しない選択も含めて判断します。30分で方向が分かれば、その場で終了して構いません。",
  },
  {
  ...
  advisor: {
    ...
    paidSupport: [
      ...
      },
      {
        ...
        support: "必要な技術・業務範囲から、採用すべき役割、経験、責任範囲、他の担当との境界を整理し、募集要項に落とし込みます",
        deliverables: ["役割定義", "エンジニア募集要項案", "面談・選考時の確認事項"],
      },
      {
        goal: "次の技術判断まで進める",
