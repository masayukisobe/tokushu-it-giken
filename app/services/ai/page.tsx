...
export default function AiServicesPage() {
  return <><SiteHeader /><main><PageHero eyebrow="注目技術テーマ" title="AIに関する技術判断" lead="AIに関する相談も、製品や導入の話だけでは終わりません。事業要件と現場の制約から、使う意味、成立条件、検証範囲を定め、導入計画と技術推進へつなげます。" />
    <section className="ai-overview" aria-labelledby="ai-overview-title"><div className="container"><h2 id="ai-overview-title">AIは、既存の四つの「分からない」を横断する技術テーマです</h2><p>相談先の探索、構想の評価、提案の比較、開発の打開。それぞれの段階でデータ・精度・コスト・運用の成立条件を確かめ、役割・判断の節目・実行手順を計画します。</p></div></section>
