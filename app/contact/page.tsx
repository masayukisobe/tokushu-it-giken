...
export default function ContactPage() {
  return <><SiteHeader /><main className="contact-page">
    <section className="contact-hero" aria-labelledby="contact-title"><div className="container"><p className="eyebrow">初回30分無料相談</p><h1 id="contact-title">まずは30分、判断を前へ進めます</h1><p>その場で回答できることは、その場で回答します。追加確認が必要な場合は、未確認事項、判断基準、担当すべき役割、確認する順序を明らかにします。30分で方向が定まれば、それで完了です。継続支援が必要な場合のみ、支援範囲と実行計画をご提案します。</p></div></section>
