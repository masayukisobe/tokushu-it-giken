...
export default function ContactPage() {
  return <><SiteHeader /><main className="contact-page">
    <section className="contact-hero" aria-labelledby="contact-title"><div className="container"><p className="eyebrow">初回30分無料相談</p><h1 id="contact-title">まずは30分、その場で整理します</h1><p>初回30分は無料です。その場で解決できることは回答し、30分で十分なら、それで完了です。追加の調査・検証・設計・実装が必要な場合だけ、その先をご提案します。</p></div></section>
