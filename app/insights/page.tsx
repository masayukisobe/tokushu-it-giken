...
export default function InsightsPage() { return <><SiteHeader /><main><PageHero title="技術課題を、解ける形へ整理する知見" lead="特殊IT技研では、個別の技術だけでなく、技術課題がなぜ解けなくなるのか、どのように整理すれば判断できるのかを研究・発信しています。" />
