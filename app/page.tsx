...
export default function Home() {
  return <><SiteHeader /><main>
    ...
    <section className="home-consultation-summary" aria-labelledby="consultation-summary-title"><div className="container home-consultation-layout"><div><p className="eyebrow">初回30分無料相談</p><h2 id="consultation-summary-title">まずは30分、その場で整理します</h2><p>初回30分は無料です。その場で解決できることは回答し、30分で十分ならそこで終了します。追加の調査・検証・設計・実装が必要な場合だけ、その先をご提案します。</p></div><Link className="button button-primary" href="/contact">30分無料で相談する <span aria-hidden="true">→</span></Link></div></section>
  </main><SiteFooter /></>;
}
